...
const FifthContentHero = () => {
  return (
    <section className="py-10 bg-white dark:bg-black sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
          ...
          <div className="flex flex-col items-start xl:px-16">
            <h2 className="text-3xl font-bold leading-tight dark:text-white text-black sm:text-4xl lg:text-5xl">
...
export default FifthContentHero;
