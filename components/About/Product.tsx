...
export function Product() {
  return (
    <div className=" w-[40rem] mx-auto container grid place-items-center grid-cols-1 md:grid-cols-2">
      ...
      <div>
        ...
        <Typography className="mt-4 text-base font-normal leading-[27px] text-gray-500 dark:text-white">
