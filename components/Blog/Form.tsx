    ...
    <form>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <label htmlFor="username" className="dark:text-white block text-sm font-medium leading-6 text-gray-900">
                Username
              </label>
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <span className="flex select-none items-center pl-3 text-gray-500 dark:text-white sm:text-sm">workcation.com/</span>
                  <input
                    type="text"
                    name="username"
                    id="username"
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-white">Write a few sentences about yourself.</p>
            </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                <UserCircleIcon className="h-12 w-12 text-gray-300 dark:text-white" aria-hidden="true" />
                <button
                  type="button"
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                <div className="text-center">
                  <PhotoIcon className="mx-auto h-12 w-12 text-gray-300 dark:text-white" aria-hidden="true" />
                  <div className="mt-4 flex text-sm leading-6 text-gray-600 dark:text-white">
                    <label
                      htmlFor="file-upload"
                      className="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 dark:text-white focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500"
                    >
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Use a permanent address where you can receive mail.</p>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                >
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 space-y-10">
                ...
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                    <input
                      ...
                      name="comments"
                      type="checkbox"
                      className="h-4 w-4 rounded border-gray-300 text-indigo-600 dark:text-white focus:ring-indigo-600"
                    />
                  </div>
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500 dark:text-white">Get notified when someone posts a comment on a posting.</p>
                  </div>
                </div>
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500 dark:text-white">Get notified when a candidate applies for a job.</p>
                  </div>
                </div>
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500 dark:text-white">Get notified when a candidate accepts or rejects an offer.</p>
                  </div>
                </div>
              </div>
            </fieldset>
            <fieldset>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-white">These are delivered via SMS to your mobile phone.</p>
              <div className="mt-6 space-y-6">
                <div className="flex items-center gap-x-3">
                  <input
                    ...
                    type="radio"
                    className="h-4 w-4 border-gray-300 text-indigo-600 dark:text-white focus:ring-indigo-600"
                  />
